...
Update_Status SceneLevel13::Update()
{
...
Update_Status SceneLevel13::PostUpdate()
{
	...
	if (win) App->fade->FadeToBlack((Module*)App->sceneLevel_13, (Module*)App->sceneLevel_14, 90);
	...
	if (App->debug->GMODE == true)
	{
		if (App->debug->descending == true)
		{
			...
			App->fade->FadeToBlack((Module*)App->sceneLevel_13, (Module*)App->sceneLevel_12, 90);
		}
	}
	return Update_Status::UPDATE_CONTINUE;
}
